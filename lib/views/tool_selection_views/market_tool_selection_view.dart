...
import 'package:eve_helper/views/tool_views/market_tool_views/sells_below_jita_buy_tool_view.dart';
import 'package:eve_helper/views/tool_views/market_tool_views/sells_below_jita_sell_tool_view.dart';
      ...
      body: ListView(
        ...
        children: [
          ...
          CardTile(
            ...
            title: Text('Sells Below Jita Sell'),
            subtitle: Text('Finds all the sell orders of an item in a region that is below a certain percentage of Jita sell.'),
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => SellsBelowJitaSellToolView())),
          ),
          CardTile(
            leading: SizedBox(
              width: 40,
            ...
            subtitle: Text('Finds all the sell orders of an item in a region that is below a certain percentage of Jita buy.'),
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => SellsBelowJitaBuyToolView())),
          ),
        ],
      ),
    );
