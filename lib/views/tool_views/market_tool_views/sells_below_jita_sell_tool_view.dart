...
class SellsBelowJitaSellToolView extends StatefulWidget {
  SellsBelowJitaSellToolView({Key key}) : super(key: key);

  @override
  _SellsBelowJitaSellToolViewState createState() => _SellsBelowJitaSellToolViewState();
}

class _SellsBelowJitaSellToolViewState extends State<SellsBelowJitaSellToolView> {
  ...
  void _filterBelowPercentJob(List<MarketOrder> input, List<DataGridRow> output) async {
    ...
    _jobIndex++;
    try {
      double jita = await _getJitaMinSell(assigned.typeId);
